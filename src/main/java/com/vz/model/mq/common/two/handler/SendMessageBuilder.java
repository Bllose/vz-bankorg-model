 ...
 * @Package: com.vz.model.mq.common.two.handler
 * @ClassName: SendMessageBuilder
 * @Description: java类作用描述
 * @Author: Bllose
 * @CreateDate: 2019/8/1 11:21
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/8/1 11:21
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class SendMessageBuilder {
     ...
     * */
    public static void message2DataCheck(MQMessage mqMessage, String actionName, String source, String nsrsbh,
     ...
     * */
    public static void message2ExceptionServer(MQMessage mqMessage, String source, String actionName,
     ...
     * */
    public static void errorMessage2ExceptionServer(MQMessage mqMessage, String source, String nsrsbh, String actionName,
